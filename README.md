...
21/01/1398 | Lecture 6-Learning Bayesian networks (Bayesian paramater estimation, fully observed data) ([slides](lectures/06learning-bayesian-parameter-estimation.pdf)) | **Required**: Koller Textbook, Sec. 17.3 |  HW6  | 
