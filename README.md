...
6/12/1397 | Lecture 3- Bayesian network representation 2 ([slides](lectures/02Bayesian-networks-2.pdf)) <br> <br> Tutorial- Introduction to R by Samaneh Maleknia ([slides](tutorials/01IntroductiontoR.pdf)) | **Required**: Koller Textbook, Sec. 3.3.1, 3.3.4, 3.4.1, 3.4.2 <br> **Optional**: Koller Textbook,  Sec. 3.3.2, 3.3.3 | HW3 | 
