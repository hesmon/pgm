...
13/12/1397 | Lecture 4- Conditional probability distributions; Gaussian Bayesian networks ([slides](lectures/04CPDs-GBN.pdf)) <br> <br> Tutorial 2- Lagrange multiplier; multivariate Gaussian distributions ([slides](tutorials/02IntroToRVandND.pdf)) | **Required**: Koller Textbook, Sec. 5.1, 5.2, 5.3, 5.4.2, 5.5, 7.1-2 <br> **Optional**: McGeachie, 2014 ([link](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1003676)) | HW4 | 
