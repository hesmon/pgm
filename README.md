...
13/12/1397 | Lecture 4- Conditional probability distributions; maximum likelihood estimation (slides) <br> <br> Tutorial 2- Lagrange multiplier; multivariate Gaussian distributions (slides) |  | HW4 | 
