...
20/12/1397 | Lecture 5- Learning Bayesian networks (MLE, fully observed data) ([slides](lectures/05learning-overview.pdf))  <br> <br> Tutorial 3- Introduction to overfitting, Beta and Dirichlet distributions  ([slides](tutorials/03IntroToOverfitting.pdf)) | **Required**: Koller Textbook, Sec. 17.1-2  <br> **Optional**:  Koller Textbook, Ch. 16 | HW5 ( will be uploaded on 10/01/1398) | 
19/01/1398 | Lecture 6-Learning Bayesian networks (Bayesian inference, fully observed data) |  | Project 2 <br> HW6  | 
