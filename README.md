...
29/11/1397 | Lecture 2- Bayesian network representation ([slides](lectures/02Bayesian-networks.pdf)) <br> <br> Tutorial- Introduction to R by Samaneh Maleknia (slides)| **Required**: Koller Textbook, Sec. 3.1, 3.2, 3.3.1 <br> **Optional**: Koller Textbook, Sec. 3.3.2, 3.3.4| [HW2](homeworks/HW2.pdf "Problem set 2") | 
