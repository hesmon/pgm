...
28/01/1398 | Lecture 7- Bayesian estimation in Bayesian networks (slides) <br> <br> Tutorial 4- Introduction to JAGS ([slides](tutorials/04IntroToITandJAGS.pdf)) |  | HW7 |
