...
28/01/1398 | Lecture 7- Bayesian estimation in Bayesian networks (slides) <br> <br> Tutorial 4- Introduction to information theory and JAGS ([slides](tutorials/04IntroToITandJAGS.pdf)) |  | HW7 <br>  [JAGS-Example](tutorials/JAGS-test)  |
